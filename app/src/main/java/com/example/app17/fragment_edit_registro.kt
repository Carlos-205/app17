...
// Se ejecuta cuando el usuario acepta o rechaza el permiso.
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_edit_registro, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val etNumero    = view.findViewById<EditText>(R.id.et_editar_numero)
    ...
    private fun guardarCambios(
        ...
        // Validaciones
        if (nombres.isEmpty() || numero.isEmpty() || correo.isEmpty()) {
            Toast.makeText(requireContext(),
                "Nombres, numero y correo son obligatorios",
                Toast.LENGTH_SHORT).show()
            return
        }
        ...
        lifecycleScope.launch {
            try {
                ...
                if (uriFotoSeleccionada != null) {
                    ...
                    Log.d("DEBUG_FOTO", "fotoUrl retornada: $fotoUrl")
                }
